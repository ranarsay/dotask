...
class _GoalsScreen1State extends State<GoalsScreen1> {
  ...
  createGoals() {
    DocumentReference documentReference = 
       FirebaseFirestore.instance.collection("profileInfo").doc(userID).collection("user_goals_short").doc(title);
  ...
  deleteGoals(item) {
    DocumentReference documentReference =
    FirebaseFirestore.instance.collection("profileInfo").doc(userID).collection("user_goals_short").doc(item);
 ...
 Widget body() {
  return Container(
    child: Expanded(
    child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("profileInfo").doc(userID).collection("user_goals_short").snapshots(),
