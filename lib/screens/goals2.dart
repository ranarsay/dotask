...
class GoalsScreen2 extends StatefulWidget{
  static const route = "/goalsList";

  @override
  _GoalsScreen2State createState() => _GoalsScreen2State();
}

class _GoalsScreen2State extends State<GoalsScreen2> {
  ...
  createGoals() {
    DocumentReference documentReference = 
       FirebaseFirestore.instance.collection("profileInfo").doc(userID).collection("user_goals_long").doc(title);
  ...
  deleteGoals(item) {
    DocumentReference documentReference =
    FirebaseFirestore.instance.collection("profileInfo").doc(userID).collection("user_goals_long").doc(item);
  ...
  Widget build(BuildContext context) {
    ...
    children: <Widget>[
      Text("My Goals", style: TextStyle(color: Colors.black, fontSize: 25, fontWeight: FontWeight.bold),),
    ],),
    );
  }
 ...
 Widget body() {
  return Container(
    child: Expanded(
    child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("profileInfo").doc(userID).collection("user_goals_long").snapshots(),
